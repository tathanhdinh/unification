...
let main argv = 
  if Array.length argv < 1 then
    ...
    if addrIntSize = 8uy then
      ...
      Printf.printfn "done: %u/%u parsed/distinguished instructions." insCount programControlFlow.Keys.Count
      ...
      | Some entryPoint ->
          ...
          Printf.printf "write the control flow graph to %s" outputFilename
